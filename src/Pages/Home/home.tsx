    ...
    <div className='Container'> 
        <div className='GreenContainer'> 
          <div className='TextSide'>
            ...
            <p className='bodyText'>I am a fourth year Computer Science major at Northeastern University with a concentration in Software. My main interest lies in full stack web development, but I would love to have the opportunity to explore other fields. </p>
          </div>
